...
- Preserve important clinical document structure: header, patient, sections, entries, coded values, and media.
...
- [Platform Guide](docs/platform-guide.md): Apple, Android, React Native, and Flutter package direction.
...
The Apple package includes parser behavior tests, XML error tests, shared sample corpus checks, conformance snapshot checks, and parser performance measurements.
